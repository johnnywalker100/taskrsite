              ...
              <ul className="space-y-4 text-lg text-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Overdue tasks turn on Screen Time and block the apps or categories you picked.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-mint-dark mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground">Kids send a quick photo when they finish. Approve, reject, or extend the deadline.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-mint-dark mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground">Before the deadline, everything stays open. Taskr only locks apps when a task is late.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-mint-dark mt-1" />
                  <div>
                    <p className="font-semibold">Custom exceptions</p>
                    <p className="text-muted-foreground">Block distractions while keeping essentials like school apps, calls, or messages available.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-mint-dark mt-1" />
                  <div>
                    <p className="font-semibold">Per-task control</p>
                    <p className="text-muted-foreground">Pick specific apps, categories, or device-level limits for each task.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-mint-dark mt-1" />
                  <div>
                    ...
                    <p className="text-muted-foreground">Everything works through Apple's built-in Family Controls.</p>
                  </div>
                </li>
              </ul>
            </div>
